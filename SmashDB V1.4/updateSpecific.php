...
<html>
	...
	<body>	
		...
		?>
		<form method = "post" action = "updateCompleted.php">
			<select name = "SelectSpecific" style = "border-radius: 0.5em">
				<?php
				
					echo "<option value = \"Select Player to Update\">Select Player to Update</option>";
					...
					if($_SESSION["Table"] == "Where a Player is From")
					{
						...
						echo "<input type = \"search\" name = \"search\" placeholder = \"Enter Where Player Lives Now\">
							<input type = \"submit\" style = \"border-radius: 0.5em; border: 2px solid #4286f4; background-color: #4faf9e;\">";
