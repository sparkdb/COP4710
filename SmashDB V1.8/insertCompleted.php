			...
			{			
				...
				else if($_SESSION["SelectTable"] == "Tournament")
				{
					...
					$_SESSION['SelectSeasonYear'] != "Select Season Year")
					{
						...
						{
							echo "player ".$i."<br><br>";
							echo "<input type = \"text\" name = \"player".$i."\"><br><br>";
							$i++;
						}
						...
						{
							echo "set ".$i."<br><br>";
							echo "<input type = \"text\" name = \"set".$i."_1\">";
							echo " vs. ";
							echo "<input type = \"text\" name = \"set".$i."_2\"><br><br>";
							echo "<input type = \"text\" name = \"setCount".$i."_1\">";
							echo " - ";
							echo "<input type = \"text\" name = \"setCount".$i."_2\"><br><br>";
							
							$i++;
						}
						echo "<input type = \"submit\" style = \"border-radius: 0.5em; border: 2px solid #4286f4; background-color: #4faf9e;\">";
						echo "</form>";
					}
					else
					{
