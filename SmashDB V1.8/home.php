...
<html>
	<head>
		<title>Actual Home - SmashDB</title>
	...
	<body>	
		<div class="header">
			<a href="resultPage.php">Result</a>
			<a href="insertionPage.php">Insert</a>
			<a href="deletionPage.php">Delete</a>
			<a href="updatePage.php">Update</a>
			<a href="index.php" id="login">Log Out</a>
		</div>
		<br><br>
		<div class="SmashBros">
